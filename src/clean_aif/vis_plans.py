...
def main():
    ...
    # Plotting categorical distributions Q(S|pi) from the first step of an episode (averaged over the runs)
    plot_Qs_pi_first(
        file_dp,
        params["select_policy"],
    ...
    # Plotting categorical distributions Q(S|pi) from the last step of an episode (averaged over the runs)
    # plot_Qs_pi_final(
    #     file_dp,
    #     params["select_policy"],
    #     params["select_episode"],
    #     result_dir,
    #     params["env_layout"],
    # )  # Commenting it out because policies at the last step are not across agents/runs.
    # Plotting categorical distributions Q(S_i) from the last step of an episode (averaged over the runs)
    plot_Qs(
        file_dp,
        params["select_episode"],
        result_dir,
